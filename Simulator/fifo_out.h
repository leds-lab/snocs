...
#ifdef FIFO_OUT_DEPTH
#undef FIFO_OUT_DEPTH
#define FIFO_OUT_DEPTH 0
#endif
...
////////////////////////////////////////////////////////////////////////////////
{
    ...
    sc_in<Flit>  din;   // input 	data channel
    sc_out<Flit> dout;  // output	data channel
    ...
    sc_signal<Flit> fifo[FIFO_OUT_DEPTH];   // here is the buffer
